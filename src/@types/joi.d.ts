...
declare module 'joi' {
  ...
  interface BoxAnySchema<N extends Box<any, boolean>> extends joi.AnySchema {
    ...
    default<T>(
      value: T,
      description?: string,
    ): this extends BoxAnySchema<infer B>
      ? BoxAnySchema<BoxUnion<B, T>>
      : never;
    ...
    required(): this extends BoxAnySchema<infer B>
      ? BoxAnySchema<BoxReq<B, true>>
      : never;
    required(): this;
    exist(): this extends BoxAnySchema<infer B>
      ? BoxAnySchema<BoxReq<B, true>>
      : never;
    exist(): this;
    optional(): this extends BoxAnySchema<infer B>
      ? BoxAnySchema<BoxReq<B, false>>
      : never;
    optional(): this;
  }
  ...
  interface BoxStringSchema<N extends BoxSchema> extends joi.StringSchema {
    ...
    default<T extends string>(
      value: T,
      description?: string,
    ): this extends BoxStringSchema<infer B>
      ? BoxStringSchema<BoxUnion<B, T>>
      : never;
    default(value: any, description?: string): this;
    default(): this;
    ...
    required(): this extends BoxStringSchema<infer B>
      ? BoxStringSchema<BoxReq<B, true>>
      : never;
    required(): this;
    exist(): this extends BoxStringSchema<infer B>
      ? BoxStringSchema<BoxReq<B, true>>
      : never;
    exist(): this;
    optional(): this extends BoxStringSchema<infer B>
      ? BoxStringSchema<BoxReq<B, false>>
      : never;
    optional(): this;
  }
  ...
  interface BoxNumberSchema<N extends BoxSchema> extends joi.NumberSchema {
    ...
    default<T extends number>(
      value: T,
      description?: string,
    ): this extends BoxNumberSchema<infer B>
      ? BoxNumberSchema<BoxUnion<B, T>>
      : never;
    default(value: any, description?: string): this;
    default(): this;
    ...
    required(): this extends BoxNumberSchema<infer B>
      ? BoxNumberSchema<BoxReq<B, true>>
      : never;
    required(): this;
    exist(): this extends BoxNumberSchema<infer B>
      ? BoxNumberSchema<BoxReq<B, true>>
      : never;
    exist(): this;
    optional(): this extends BoxNumberSchema<infer B>
      ? BoxNumberSchema<BoxReq<B, false>>
      : never;
    optional(): this;
  }
  ...
  interface BoxBooleanSchema<N extends BoxSchema> extends joi.BooleanSchema {
    ...
    default<T extends boolean>(
      value: T,
      description?: string,
    ): this extends BoxBooleanSchema<infer B>
      ? BoxBooleanSchema<BoxUnion<B, T>>
      : never;
    default(value: any, description?: string): this;
    default(): this;
    ...
    required(): this extends BoxBooleanSchema<infer B>
      ? BoxBooleanSchema<BoxReq<B, true>>
      : never;
    required(): this;
    exist(): this extends BoxBooleanSchema<infer B>
      ? BoxBooleanSchema<BoxReq<B, true>>
      : never;
    exist(): this;
    optional(): this extends BoxBooleanSchema<infer B>
      ? BoxBooleanSchema<BoxReq<B, false>>
      : never;
    optional(): this;
  }
  ...
  interface BoxDateSchema<N extends BoxSchema> extends joi.DateSchema {
    ...
    default<T extends Date>(
      value: T,
      description?: string,
    ): this extends BoxDateSchema<infer B>
      ? BoxDateSchema<BoxUnion<B, T>>
      : never;
    default(value: any, description?: string): this;
    default(): this;
    ...
    required(): this extends BoxDateSchema<infer B>
      ? BoxDateSchema<BoxReq<B, true>>
      : never;
    required(): this;
    exist(): this extends BoxDateSchema<infer B>
      ? BoxDateSchema<BoxReq<B, true>>
      : never;
    exist(): this;
    optional(): this extends BoxDateSchema<infer B>
      ? BoxDateSchema<BoxReq<B, false>>
      : never;
    optional(): this;
  }
  ...
  interface BoxFunctionSchema<N extends BoxSchema> extends joi.FunctionSchema {
    ...
    allow<T>(
      ...values: T[]
    ): this extends BoxFunctionSchema<infer B>
      ? BoxFunctionSchema<BoxUnion<B, T>>
      : never;
    allow<T>(
      values: T[],
    ): this extends BoxFunctionSchema<infer B>
    ...
    required(): this extends BoxFunctionSchema<infer B>
      ...
      : never;
    required(): this;
    exist(): this extends BoxFunctionSchema<infer B>
      ? BoxFunctionSchema<BoxReq<B, true>>
      : never;
    exist(): this;
  ...
  interface BoxArraySchema<N extends BoxSchema> extends joi.ArraySchema {
    ...
    default<T extends any[]>(
      value: T,
      description?: string,
    ): this extends BoxArraySchema<infer B>
      ? BoxArraySchema<BoxUnion<B, ArrayType<T>>>
      : never;
    ...
    items<T extends mappedSchema>(
      ...
      ? BoxArraySchema<BoxUnion<B, extractType<T>>>
      : never;

    items(...types: joi.SchemaLike[]): this;
    items(types: joi.SchemaLike[]): this;

    required(): this extends BoxArraySchema<infer B>
      ? BoxArraySchema<BoxReq<B, true>>
      : never;
    required(): this;
    exist(): this extends BoxArraySchema<infer B>
      ? BoxArraySchema<BoxReq<B, true>>
      : never;
    exist(): this;
    optional(): this extends BoxArraySchema<infer B>
      ? BoxArraySchema<BoxReq<B, false>>
      : never;
    optional(): this;
  }
  ...
  interface BoxObjectSchema<N extends BoxSchema> extends joi.ObjectSchema {
    ...
    default<T extends mappedSchemaMap>(
      ...
      ? BoxObjectSchema<BoxUnion<B, extractType<T>>>
      : never;
    default(value: any, description?: string): this;
    default(): this;
    ...
    pattern<S extends BoxStringSchema<any>, T extends mappedSchema>(
      ...
      ? BoxObjectSchema<
          BoxIntersection<B, extractMap<{ [key in extractType<S>]: T }>>
        >
      : never;
    ...
    required(): this extends BoxObjectSchema<infer B>
      ? BoxObjectSchema<BoxReq<B, true>>
      : never;
    required(): this;
    exist(): this extends BoxObjectSchema<infer B>
      ? BoxObjectSchema<BoxReq<B, true>>
      : never;
    exist(): this;
    optional(): this extends BoxObjectSchema<infer B>
      ? BoxObjectSchema<BoxReq<B, false>>
      : never;
    optional(): this;
  }
  ...
  interface BoxAlternativesSchema<N extends BoxSchema>
    ...
    allow<T>(
      ...values: T[]
    ): this extends BoxAlternativesSchema<infer B>
      ? BoxAlternativesSchema<BoxUnion<B, T>>
      : never;
    allow<T>(
      values: T[],
    ): this extends BoxAlternativesSchema<infer B>
